const Footer = () => {
  return (
    <div className="mt-5">
      <div className="container-fluid p-md-5 text-white bg-normal">
          ...
          <div className="col-md-6">
            ...
            <span>
              <p>
                ...
                Website: https://www.thienshinhan.com/
              </p>
            </span>
          </div>
          <div className="col-md-6">
            <div className="row">
              <h4 className="fw-bold">Đáp ứng mọi nhu cầu của khách hàng</h4>
            </div>
            <div className="row">
              <div className="row">
                <div className="col-md-6">
              ...
              <div className="row">
                <span>
                  ...
                  />
                  <img
                    className="icon_contact ml-contact"
