  ...
  return (
    <>
          ...
          <div className="col-md-6">
            <div className="row">
              <div className="col-md-2 number">
                <div id="SHAPE77" className="ladi-element">
              ...
              <ul>
                <li className="fs-5">Sổ hộ khẩu.</li>
                <li className="fs-5">Chứng minh thư/Căn cước công dân.</li>
                <li className="fs-5">
                  Phiếu Lương Hoặc Xác Nhận Lương (Đối Với Lương Tiền Mặt).
                </li>
                <li className="fs-5">
        ...
        <div className="row d-flex zindex-fixed justify-content-center text-center w-100">
          ...
          <div className="row d-flex zindex-fixed justify-content-center text-center mt-5 w-100">
            <div className="row mt-5 d-flex zindex-fixed justify-content-center  center_content_2 center-content_radius">
              <div className="col-6">
                <img
                  className="mt-5 w-50 center-content_radius"
              ...
              <div className="col-6">
                ...
                <div className="text-start">
                  <h5>
                    <i className="fa fa-check icon_check"></i>Vay theo lương
                    (chuyển khoản hoặc tiền mặt)
                  </h5>
                  <h5>
                    <i className="fa fa-check icon_check"></i>Vay theo bảo hiểm
                    nhân thọ.
                  </h5>
                  <h5>
                    <i className="fa fa-check icon_check"></i>Vay theo hợp đồng
                    tín dụng ở tổ chức tín dụng khác.
                  </h5>
                  <h5>
        ...
        <div className="row d-flex zindex-fixed justify-content-center text-center mt-5 w-100">
          <div className="row mt-5 d-flex zindex-fixed justify-content-center  center_content_2 center-content_radius">
            <div className="col-6">
              ...
              <div className="text-start">
                <h6>
                  <i className="fa fa-check icon_check"></i>Độ tuổi: 18- 69 tuổi
                </h6>
                <h6>
                  <i className="fa fa-check icon_check"></i>Đi làm nhận lương
                  chuyển khoản/ tiền mặt hoặc Kinh doanh có bảo hiểm nhân thọ.
                </h6>
                <h6>
                  <i className="fa fa-check icon_check"></i>Thu nhập lương
                  chuyển khoản tối thiểu 4 triệu đồng/ tháng.
                </h6>
                <h6>
                  <i className="fa fa-check icon_check"></i>Không có nợ xấu tại
                  các tổ chức tín dụng.
                </h6>
                <h6>
                  <i className="fa fa-check icon_check"></i>Đã từng từ chối tại
                  các ngân hàng vẫn có thể tiếp tục làm hồ sơ
                </h6>
              </div>
            </div>
            <div className="col-6">
            ...
            <div className="d-flex zindex-fixed justify-content-center ">
              ...
              <div className="card content_center_5 center_content_size">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Đợi 24 tiếng tính từ ngày sau ngày ký kết hợp đồng để được
      ...
      <div className="row d-flex zindex-fixed justify-content-center text-center mt-5 w-100">
        ...
        <p>
          Bảng lãi suất chỉ mang tính chất tham khảo, để biết con số chính xác
          thì còn phụ thuộc vào nhiều điều kiện
        </p>
          ...
          <div className="row mt-5 d-flex zindex-fixed justify-content-center  center_content_3 center-content_radius">
            <div className="col-12">
              ...
              <div className="d-flex  mt-5 text-start">
                <h3>
                  Cảm Nhận Khách Hàng Khi
                  <br />
                  Vay Tiêu Dùng
                </h3>
              </div>
              <p className="text-start ">
                Chúng tôi luôn nỗ lực để đáp ứng mọi nhu cầu khách hàng
              </p>
            </div>
            <div className="col-12 d-flex position-relative">
              <div className="col-6">
                <div className="card bot_content position-absolute ms-5 mt-5 margin_text_avatar">
                  <div className=" card-body  ">
                    <img
                      className="position-absolute d-flex justify-content-start avatar avatar_size rounded-circle border border-5 border-primary"
                    ...
                    <div>
                      ...
                      <br />
                      <p className="ms-5 text-white display_mobile">
                        Sinh năm 1994 Cầu Giấy - Hà Nội
                      </p>
                  ...
                  <div>
                    <p className="text_bot_content position-absolute mt-5  text-start">
                      <svg
                        className="icon_bot_content"
                        xmlns="http://www.w3.org/2000/svg"
                        width="8%"
                        height="40%"
                        preserveAspectRatio="none"
                        viewBox="0 0 129.34 107.78"
                        fill="rgba(232, 183, 48, 1)"
                      >
                      ...
                      <br />
                      Mình mới đăng ký tầm 24h phút xong giải ngân luôn. Hằng
                      tháng có các bạn tư vấn nhắc nhở đóng phí khỏi lo việc
                      quên đóng phí ảnh hưởng đến điểm tín dụng.
                      <svg
                        className="icon_bot_content_rotate "
                        xmlns="http://www.w3.org/2000/svg"
                        width="10%"
                        height="20%"
                        preserveAspectRatio="none"
              ...
              <div className="col-6 ">
                <div>
                  <p className="text_bot_content position-absolute mt-5  text-start">
                    ...
                    <br />
                    Mình mới đăng ký tầm 24h phút xong giải ngân luôn. Hằng
                    tháng có các bạn tư vấn nhắc nhở đóng phí khỏi lo việc quên
                    đóng phí ảnh hưởng đến điểm tín dụng.
                    <svg
                      className="icon_bot_content_rotate"
                      xmlns="http://www.w3.org/2000/svg"
                      width="5%"
                ...
                <div className="bot_content position-absolute bot_content_right ">
                  ...
                  <div className=" card-body ">
                    <img
                      className="position-absolute d-flex justify-content-end avatar_right avatar_size rounded-circle border border-5 border-primary"
                    ...
                    <div>
                      ...
                      <br />
                      <p className="ms-5 text-white text-start display_mobile">
                        IT sinh năm 1992 Hòa Xuân-Đà Nẵng
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <div className="position-absolute bot_content_2 text-center w-100">
        <div className="col-6 text_bot_content_2 bot_content_normal ">
          <div className="text-start text-white mt-5">
            ...
            <div className="text-start ms-5 me-5 mt-5 font_size_text">
              <p>
              ...
              <p>
                &#8861; Tùy Nhu Cầu mà các khoản vay thời gian vay tối thiểu là
                12 tháng ( 365 ngày ) và tối đa 48 tháng ( 1440 ngày)
              </p>
              <p>
                &#8861; Tùy vào nhu cầu lãi suất tối thiểu 9.6%/1năm – lãi suất
                tối đa 18%/1 năm
              </p>
              <p>&#8861; Các khoản vay dài hạn sẽ được hỗ trợ ưu đãi:</p>
              <p>
                &#8861; Ví dụ: Nguyên Văn A vay 30 triệu trong 12 tháng và trả
                góp mỗi tháng gốc + lãi là 2.750.000 vậy sau 12 tháng tổng lãi +
                gốc là 33 triệu suy ra số tiền lãi là 3 triệu vậy lãi suất:
                10%/năm – đây là tạm tính còn thực tế là lãi suất tính trên dư
                nợ giảm dần nên khách hàng sẽ chỉ phải trả ít hơn khi còn nợ ít.
              </p>
              <p>
                &#8861; Nhưng nếu Nguyễn Văn A vay 30 triệu trả trong vòng 48
                tháng thì mỗi tháng sẽ phải trả góp 881.000đ vậy tổng sau 48
                tháng cả gốc và lãi là : 42.300.000 trừ đi gốc tiền lãi là
                15.720.000 trong 4 năm thì mỗi năm lãi là 3.074.000 sấp sỉ
                10%/năm. đây là tạm tính còn thực tế là lãi suất tính trên dư nợ
                giảm dần nên khách hàng sẽ chỉ phải trả ít hơn khi còn nợ ít.
              </p>
      ...
      <div className="position-absolute bot_content_3 d-flex zindex-fixed justify-content-end text-center w-100 margin_bot_content">
        <div className="col-6 text_bot_content_3 position-absolute">
          <div className="text-start text-white mt-5">
            <img
              className="image_bot_content_3 "
              src="/images/image_bot_content_3.png"
              alt=""
            />
          </div>
          <FormContact />
          ...
          <div className="text-start text-white mt-5">
            ...
            <div className="text-start ms-5 me-5 mt-5 font_size_text">
              <p className="fw-bold">
                ...
                mình, bạn cần biết số tiền phải trả sẽ chiếm bao nhiêu trong thu
                nhập hàng tháng và bạn có thể trả nó mà vẫn sống bình thường
                được. Số tiền chi trả hàng tháng không nên vượt quá 40% tổng thu
                nhập hàng tháng của bạn.
              </p>
              <p>
                &#8861; Các ngân hàng/Tổ chức tín dụng sẽ bị thiệt nếu bạn trả
                nợ sớm, do đó các ngân hàng/Tổ chức tín dụng thường đưa ra ít
                nhất là 2% nợ gốc còn lại làm phí thanh lý hợp đồng mà bạn phải
                trả thêm nếu bạn tiến hành tất toán trước hạn. Nhưng đổi lại,
                bạn sẽ không phải đóng thêm phần lãi nào cả.
              </p>
              <p>
                &#8861; Khách hàng vay tín chấp cũng cần hiểu đúng về lãi suất
                vay tại ngân hàng/Tổ chức tín dụng. Các ngân hàng/Tổ chức tín
                dụng thường đưa ra 2 cách tính lãi suất đó là lãi suất giảm dần
                và lãi suất cố định
              </p>
              <p>
                &#8861; Trong phương pháp tính lãi suất giảm dần: số tiền phải
                thanh toán cho lãi suất khoản vay của bạn vẫn tiếp tục giảm dựa
                trên số tiền gốc hàng tháng được giảm, nguyên tắc là được giảm
                hàng tháng, hàng quý hoặc hàng năm.
              </p>
              <p>
                &#8861; Trong phương thức tính lãi suất cố định, số tiền phải
                thanh toán cho lãi suất khoản vay của bạn vẫn không đổi trong
                thời gian vay, đơn giản chỉ vì số tiền này được tính dựa vào số
                dư nợ gốc ban đầu.
              </p>
              <p>
                &#8861; Thời hạn khoản vay mặc định, có thể trả trước hạn linh
                hoạt tùy vào mông muốn của Khách hàng.
              </p>
              <p>
